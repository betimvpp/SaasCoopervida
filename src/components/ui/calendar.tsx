...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn("p-3 w-full h-full", className)} // Aqui as classes w-full h-full
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-full h-full font-normal text-[0.8rem]",
        ...
        day: cn(
          ...
          "h-[10rem] w-[10rem] p-0 font-normal aria-selected:opacity-100"
        ),
